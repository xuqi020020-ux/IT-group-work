...
from .models import Document, DocumentShare, EditSuggestion, Comment, DocumentAttachment, Notification
...
def moderate_documents(modeladmin, request, queryset):
    for doc in queryset:
        Notification.objects.create(
            recipient=doc.owner,
            message=f"Your document '{doc.title}' was MODERATED (Content requires revision).",
